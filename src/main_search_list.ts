...
const pathToNumber: Record<string, number> = {
    ...
    'bot_emily|emily': 96,
    'screen_shot_action|screenshot': 95,
    'link_reader|summarize_webpage': 94,
    'writing_package|summarize': 93,
    'writing_package|explain': 92,
    'writing_package|emoji': 91,
    'translate|deepl': 90,
    'translate|google': 89,
    'ocr_action|silent_screenshot_ocr': 88,
    'ocr_action|screenshot_translate': 87,
    'tts|read_aloud': 86,
    'tts|edge_tts': 85,
    'image_compress|tinypng': 84,
    'image_generation|image_generation': 83,
